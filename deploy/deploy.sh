...
gcloud run deploy "$SERVICE_NAME" \
  ...
  --set-secrets "DATABASE_URL=DATABASE_URL:latest,STORAGE_ACCESS_KEY=STORAGE_ACCESS_KEY:latest,STORAGE_SECRET_KEY=STORAGE_SECRET_KEY:latest,JWT_SECRET=JWT_SECRET:latest,JWT_REFRESH_SECRET=JWT_REFRESH_SECRET:latest,GEMINI_API_KEY=GEMINI_API_KEY:latest,OPENAI_API_KEY=OPENAI_API_KEY:latest,REVENUECAT_WEBHOOK_SECRET=REVENUECAT_WEBHOOK_SECRET:latest,REVENUECAT_API_KEY=REVENUECAT_API_KEY:latest" \
